...
|------|------|------------|-----------|------|
| MCP 插件丰富度 | 25% | **22/25** | 23.75/25 | 旧文档虚高（声称 49 工具→实际 17） |
| 安全校验能力 | 30% | **27/30** | 27/30 | 一致，但旧文档引用已删除的 optimizer |
| 推理链路可追溯性 | 25% | **25/25** | 23.75/25 | 新版 TraceView 已补全 |
| 系统架构与创新 | 20% | **17/20** | 18/20 | 缺麒麟实机验证 + 性能基准 |
| **总分** | **100%** | **91/100** | 92.5/100 | 旧文档虚高 1.5 分 |
